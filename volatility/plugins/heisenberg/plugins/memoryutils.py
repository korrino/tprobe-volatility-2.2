...
class CanonicalHexDump(heisenberg.AbstractHeisenbergPlugin):
	name = 'db'
...
class PrintDwords(heisenberg.AbstractHeisenbergPlugin):
	name = 'dd'
	dependencies = ['get_context']
...
class PrintQwords(heisenberg.AbstractHeisenbergPlugin):
	name = 'dq'
	dependencies = ['get_context']
...
class DescribeObjectType(heisenberg.AbstractHeisenbergPlugin):
	name = 'dt'
	dependencies = ['get_context']
