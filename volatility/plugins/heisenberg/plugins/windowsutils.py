...
class GetWindowsProcessList(heisenberg.AbstractHeisenbergApiFunction):
    name = 'get_process_list'

    def calculate(self):
    	return win32.tasks.pslist(self.core.addrspace)

class GetWindowsProcessName(heisenberg.AbstractHeisenbergApiFunction):
...
class GetWindowsProcessId(heisenberg.AbstractHeisenbergApiFunction):
    name = 'get_process_id'
...
class GetWindowsProcessParentId(heisenberg.AbstractHeisenbergApiFunction):
...
class WindowsPs(heisenberg.AbstractHeisenbergPlugin):
    name = 'ps'
...
class WindowsChangeContext(heisenberg.AbstractHeisenbergPlugin):
    name = 'cc'
...
class UpdateCurrentContext(heisenberg.AbstractHeisenbergApiFunction):
    name = 'update_context'
...
class GetWindowsContext(heisenberg.AbstractHeisenbergApiFunction):
    name = 'get_context'
...
class CreateWindowsProcessObject(heisenberg.AbstractHeisenbergApiFunction):
