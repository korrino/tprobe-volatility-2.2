...
class BaseScanner(object):
    ...
    def scan(self, address_space, offset = 0, maxlen = None):
        return self.gdb_scan(address_space, offset, maxlen) if cfg.GDB else self.orig_scan(address_space, offset, maxlen)

    def orig_scan(self, address_space, offset = 0, maxlen = None):
    ...
    def gdb_scan(self, address_space, offset = 0, maxlen = None):
        ...
        ## Which checks also have skippers?
        # are skippers still necessary? guess not
        #skippers = [ c for c in self.constraints if hasattr(c, "skip") ]
